...
output "ecs_service_cluster" {
  ...
  value       = module.ecs_ec2.ecs_service_cluster
}

output "ecs_service_id" {
  description = "ARN that identifies the service."
  value       = module.ecs_ec2.ecs_service_id
}

output "ecs_service_name" {
  description = "Name of the service."
  value       = module.ecs_ec2.ecs_service_name
}

output "ecs_td_arn" {
  description = "Full ARN of the Task Definition (including both family and revision)"
  value       = module.ecs_ec2.ecs_td_arn
}

output "ecs_td_family" {
  description = "The family of the Task Definition."
  value       = module.ecs_ec2.ecs_td_family
}

output "ecs_td_revision" {
  description = "The revision of the Task Definition."
  value       = module.ecs_ec2.ecs_td_revision
}
