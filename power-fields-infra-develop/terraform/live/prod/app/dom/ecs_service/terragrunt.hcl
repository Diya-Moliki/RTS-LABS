...
inputs = {
    ...
    ecs_cluster = dependency.ecs_cluster.outputs.ecs_cluster_arn
    ...
    cors_allowed_domains  = "https://${dependency.cloudfront.outputs.external_domain}"
    fe_base_url           = "https://${dependency.cloudfront.outputs.external_domain}"
    whitelisted_email_domains = ""  #allow sending of emails tyo any domain
